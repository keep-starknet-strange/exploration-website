...
export function Speakers() {
  ...
  return (
    <section id="speakers" aria-labelledby="speakers-title">
      ...
      <Container>
        {/* <div class="mt-14 flex justify-start flex-col w-full md:w-auto items-start pb-1">
          <button class="flex justify-start items-center space-x-6">this</button>
          <button class="flex justify-start items-center space-x-6">that</button>
          <button class="flex justify-start items-center space-x-6">the other</button>
        </div> */}
        <TabGroup
