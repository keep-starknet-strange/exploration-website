...
pub mod CredentialRegistryComponent {
    ...
    struct Storage {
        ...
        user_to_credentials: LegacyMap::<ContractAddress, felt252>,
        credentials_w_pin: LegacyMap::<felt252, ContractAddress>,
        user_to_credentials_w_pin: LegacyMap::<ContractAddress, felt252>,
